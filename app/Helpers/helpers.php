...
function updateProductVariationIdByPVID_HH(
    $product_id,
    $product_variation_id,
    $purchase_unit_price_before_discount,
    $purchase_unit_price_before_tax,
    $purchase_unit_price_inc_tax,
    $unit_selling_price_inc_tax,
    $unit_selling_price_exc_tax
) {
...
function getTotalQuantityByUnitId_HH($unit_id, $quantity)
{
    $calculation_result = unitCalculationResultByUnitId_HH($unit_id);
    return $calculation_result * $quantity;
}
