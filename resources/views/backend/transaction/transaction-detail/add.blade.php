@extends('home')
@section('title','Add Transaction Detail')
@push('css')
<style>
    .float-right {
        float: right;
...
<div class="page-content">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Add Transaction Detail</li>
        </ul>
    </div>
    <!-- /Page Breadcrumb -->
    <!-- Page Header -->
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <form action="{{route('admin.transaction-detail.store')}}" method="post">
                            @csrf
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input name="transaction_final_reference" type="text"
                                            value="{{old('transaction_final_reference')}}"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input name="transaction_date" type="date" value="{{old('transaction_date')}}"
                                            id="transaction_date" class="form-control">
                                        <div style='color:red; padding: 0 5px;'>
